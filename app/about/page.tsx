...
const AboutUs = () => {
  const { data, words } = aboutUsPageData;
        ...
        <div className="flex flex-row">
          <div className="flex flex-col text-center ">
            <div className=" mb-8 mx-4 lg:mx-8 text-center">
              ...
              <div className="text-xl md:text-2xl text-center mb-6 lg:mb-8">
        ...
        <div className="relative flex flex-col items-center justify-center py-12 px-6 mt-12">
          ...
          <div className="relative text-center z-10 max-w-3xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-black mb-12 max-w-2xl mx-auto">
              We help global businesses and startups to transform ideas into
              excellent digital products that drive results.
            </p>
            ...
            {data.map((item, index) => (
              <div key={index} className="flex items-center justify-center">
                <div className="relative w-full max-w-md bg-[#cffafe] rounded-xl shadow-md p-6 overflow-hidden group  h-[12rem] lg:h-[20rem] xl:h-[20rem]">
                  ...
                  <BiAward
                    className="absolute inset-0 w-full h-full opacity-40 text-gray-500 transition-all duration-500 ease-in-out transform group-hover:opacity-20 group-hover:scale-110"
                    fill="#0ea5e9"
                  />
                  {/* Content */}
                  <div className="relative z-10">
                    <h3 className="text-xl md:text-2xl lg:text-3xl font-semibold text-blue-600 ">
                      {item.title}
                    </h3>
